<%-- 
    Document   : capturaVideojuegoDesinventariar
    Created on : 19/04/2018, 10:24:09 PM
    Author     : Alvaro
--%>
...
<html>
    ...
    <title>Capturar datos del videojuego a desinventariar</title>
</head>
<body>
    <nav id="mainmenu"><jsp:include page="fragmentos/menuInventario.jsp" /></nav><br><br><br><br>

    <form id="Contenido" action ="">
        <center><h1 align="center">Ingrese los datos del videojuego a quitar</h1><br>
